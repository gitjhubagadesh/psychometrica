...
$factors = [
    [
        ...
        'High' => 'Test scores indicate that ' . htmlspecialchars($user->uName) .'\'s has scored in the Superior range.',
    ...
    [
        ...
        'factor_id' => 79,
        'Description' => 'The Reasoning Test assesses the ability to make inferences, to reason from information provided and to draw correct conclusions',
        'High' => 'Test scores indicate that ' . htmlspecialchars($user->uName) .'\'s has scored in the Superior range.',
        'Medium' => 'Test scores indicate that ' . htmlspecialchars($user->uName) .'\'s has scored in the Average range.',
        'Low' => 'Test scores indicate that ' . htmlspecialchars($user->uName) .'\'s has scored in the Below Average range.'
    ],
    ...
    <body>
        ...
        <div class="content">
            <table style="width: 700px; border: 2px solid orange; background-color: #fff3e6; font-family: Georgia, serif; font-size: 16px; padding: 15px;">
                ...
                <tr>
                    <td style="color: #000;">
                        The Cog Test is a test designed to measure the basic cognitive abilities of an individual. It is a comprehensive instrument that profiles 3 key cognitive abilities viz :verbal reasoning,numerical ability and non- verbal reasoning.
                    </td>
                </tr>
            </table>
...
// Map $factors array by factor_id for easy lookup
        ...
        <div class="content">
            ...
            <table style="width: 700px; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 14px; text-align: center;">
                <tr style="background-color: #e86c1a; color: #ffffff;">
                    <th style="padding: 10px; border: 1px solid #ccc; color: #fff;">Test Name</th>
                    <th style="padding: 10px; border: 1px solid #ccc; color: #fff;">No. of Questions</th>
                    <th style="padding: 10px; border: 1px solid #ccc; color: #fff;">Right</th>
                    <th style="padding: 10px; border: 1px solid #ccc; color: #fff;">Wrong</th>
                    <th style="padding: 10px; border: 1px solid #ccc; color: #fff;">Blank</th>
                </tr>

                <?php foreach ($testSummary as $factor) { ?>
                    <tr style="background-color: #f7f9fc;">
                        <td style="padding: 8px; border: 1px solid #ccc;"><?php echo ucwords(strtolower($factor['factor_name'])); ?></td>
                        <td style="padding: 8px; border: 1px solid #ccc;"><?php echo $factor['total_questions']; ?></td>
                        <td style="padding: 8px; border: 1px solid #ccc;"><?php echo $factor['correct_answers']; ?></td>
                        <td style="padding: 8px; border: 1px solid #ccc;"><?php echo $factor['wrong_answers']; ?></td>
                        <td style="padding: 8px; border: 1px solid #ccc;"><?php echo $factor['blank_answers']; ?></td>
                    </tr>
                <?php } ?>
            </table>
